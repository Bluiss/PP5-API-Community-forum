...
| GET    | /posts/:id/edit                    | Edit a specific post by ID                                |
| GET    | /profiles/:id                      | Fetch a specific profile by ID                            |
| GET    | /channel/create                    | Create a new channel                                      |
| GET    | /channels/:title                   | Fetch a specific channel by title                         |
| GET    | /profiles/:id/edit/username        | Edit username of a specific profile by ID                 |
| GET    | /profiles/:id/edit/password        | Edit password of a specific profile by ID                 |
| GET    | /profiles/:id/edit                 | Edit a specific profile by ID                             |
| GET    | /channels/:title/edit              | Edit a specific channel by title                          |
...
#### Bugs found while testing the frontend
#### Unresolved bugs
